                        ...
                        <td className="px-[13px] py-[10px] align-middle" onClick={ev => ev.stopPropagation()}>
                          <div className="flex gap-1.5 flex-wrap">
                            ...
                            {data.settings?.sheets_webhook_url && (
                              o.sheetsExportedAt ? (
                                <button type="button" disabled title={`Exported ${format(new Date(o.sheetsExportedAt), 'dd MMM yyyy')}`} className="hidden w-[26px] h-[26px] inline-flex items-center justify-center rounded-[3px] border border-[#A2DEBD] bg-[#EAF8F1] cursor-not-allowed shrink-0">
