  ...
  return (
    <div className="bg-white border border-g200 rounded-[3px]">
      ...
      <div className="p-3">
          ...
          {trend.map((w, i) => {
            if (w.pct == null) {
              return (
                <div
                  key={i}
                  className="flex-1 min-w-[6px] h-1 rounded-[2px] bg-g200"
        ...
        {/* Labels */}
        <div className="flex gap-[2px] pt-1 text-[9px] text-g500">
          {trend.map((w, i) => (
        ...
        {/* Legend */}
        <div className="flex items-center gap-3 mt-2 pt-2 border-t border-g100 text-[10.5px] text-g500 flex-wrap">
          ...
          {mtd != null && (
            <span className="ml-auto font-semibold text-blk">
              Current MTD: {mtd}%
            </span>
          )}
        </div>
